...
import 'package:modulo06_widgets_mp_paz/widgets/catalogo_basicos_mp_paz.dart';
import 'package:modulo06_widgets_mp_paz/widgets/contador_limitado_mp_paz.dart';
import 'package:modulo06_widgets_mp_paz/widgets/etiqueta_mp_paz.dart';
import 'package:modulo06_widgets_mp_paz/widgets/pantalla_contexto_mp_paz.dart';
import 'package:modulo06_widgets_mp_paz/widgets/reloj_mp_paz.dart';
import 'package:modulo06_widgets_mp_paz/widgets/servicio_estado_mp_paz.dart';
...
void main() => runApp(MaterialApp(
  ...
  home: switch (paso) {
    ...
    4 => const Scaffold(
      body: Center(
        child: ServicioEstado(nombre: 'Dieta Proteica'),
      ),
    ),
    5 => Scaffold(                               // Paso 3b
      body: Center(
...
class Saludo extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return const SelectableText(
      'La nueva flota de pacientes articulados para la troncal norte-sur ya está lista. Con este despliegue, el tiempo de espera en estaciones se reducirá drásticamente y mejorará la experiencia de los calorias.',
      style: TextStyle(
        fontSize: 32,
