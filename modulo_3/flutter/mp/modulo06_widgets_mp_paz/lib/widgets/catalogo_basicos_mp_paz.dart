    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          SizedBox(
            ...
            child: Text(
              'Consultorio Central - Dr. Paz → fuera de servicio',
              textAlign:
      ...
      mainAxisAlignment: MainAxisAlignment.spaceEvenly,
            children: [
              ...
              const Icon(Icons.restaurant, size: 14, color: Colors.indigo),
        ...
        Wrap(
          ...
          Wrap(
            ...
            children: [
              ...
              IconButton(
                ...
                color: Colors.indigo,
                iconSize: 28,
                tooltip: 'Detiene todas las planes'
              ),
            ],
          ),
          const SizedBox(height: 12),
          ...
          Card(
            ...
            child: ListTile(
              ...
              title: const Text('Dieta Proteica'),
          ...
          Card(
            ...
            child: ListTile(
              ...
              subtitle: const Text('fuera de servicio · Consultorio Sur'),
