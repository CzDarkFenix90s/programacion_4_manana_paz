  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          'Panel ${esMovil ? "móvil del Nutriologo" : "central de Despacho"} · ${esRetrato ? "Vertical" : "Horizontal"}',
      ...
      body: ListView(
        ...
        children: [
          ...
          _Seccion(
            titulo: 'Datos del Plan Alimentario / Panel',
            items: [
              ...
              'Orientación de Plan:  ${MediaQuery.paddingOf(context).top}',
            ],
          ),
          const SizedBox(height: 16),

          // ── Colores del tema ───────────────────────────────────
          _Seccion(titulo: 'Colores de la Consultorio (colorScheme)', items: []),
          Wrap(
