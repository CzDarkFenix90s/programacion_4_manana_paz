// lib/widgets/catalogo_botones_mp_paz.dart
      ...
      body: ListView(
        ...
        children: [
          ...
          TextButton.icon(
            ...
            label: const Text('Ver manual de plan'),
          ),
          ...
          FilledButton(
            ...
            onPressed: () {},
            child: const Text('Eliminar bus'),
          ),
          const SizedBox(height: 8),
          // Fila de botones compactos
          Row(children: [
            Expanded(
              child: OutlinedButton(onPressed: () {}, child: const Text('Llamar al taller')),
            ),
