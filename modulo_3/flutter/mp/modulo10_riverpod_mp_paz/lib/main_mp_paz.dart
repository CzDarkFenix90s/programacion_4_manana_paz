...
import 'package:modulo10_riverpod_mp_paz/screens/pantalla_busqueda_mp_paz.dart';
import 'package:modulo10_riverpod_mp_paz/screens/pantalla_dashboard_mp_paz.dart';
import 'package:modulo10_riverpod_mp_paz/screens/pantalla_metricas_mp_paz.dart';
import 'package:modulo10_riverpod_mp_paz/screens/pantalla_pacientes_mp_paz.dart';

// Importa las pantallas a medida que las crees en cada paso:
// import 'screens/pantalla_pacientes_mp_paz.dart';
// import 'screens/pantalla_busqueda_mp_paz.dart';
// import 'screens/pantalla_metricas_mp_paz.dart';
// import 'screens/pantalla_dashboard_mp_paz.dart';
...
void main() {
  runApp(const ProviderScope(child: AppConsultorio()));
}
...
class _Paso1 extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('Pacientes Activos')),
      body: Center(
        child: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            Text('$count', style: Theme.of(context).textTheme.displayLarge),
            const Text('pacientes activos'),
          ],
        ),
      ),
