...
class _PantallaNavegacionState extends State<PantallaNavegacion> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      // 1. EFECTO INDEXEDSTACK: Mantiene el estado y la posición del scroll 
      // de todas las pestañas al cambiar entre ellas, en lugar de destruirlas.
      body: IndexedStack(
        index: _indice,
        children: const [
          _PantallaDashboard(),
      ...
      bottomNavigationBar: NavigationBar(
        ...
        // 4. CAMBIO DE COLOR DEL INDICADOR: Cambiado de cs.primaryContainer 
        // a cs.tertiaryContainer tal como solicitaste.
...
class _PantallaDashboard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Se añadió un shrinkWrap o suficientes elementos para probar el scroll cómodamente
    return ListView(
      ...
      children: [
        ...
        // Relleno extra para forzar el scroll y comprobar que IndexedStack mantiene la posición
        ...List.generate(15, (index) => ListTile(
          title: Text('Historial de métrica #${index + 1}'),
          subtitle: const Text('Estado estable sin anomalías'),
        )),
      ],
    );
  }
...
class _PantallaServidores extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ListView.builder(
      ...
      itemCount: 15, // Incrementado para notar mejor el efecto del scroll persistente
        ...
        child: ListTile(
          ...
          onTap: () {
            ScaffoldMessenger.of(context).showSnackBar(
              SnackBar(content: Text('Abriendo prod-web-0${i + 1}')),
            );
          },
        ),
      ),
  ...
  Widget build(BuildContext context) {
    ...
    return ListView.builder(
      ...
      itemBuilder: (ctx, i) {
        ...
        return Card(
          // 3. VARIACIÓN DE COLOR AUTOMÁTICA: Cambia dinámicamente según el nivel de la alerta.
          ...
          child: ListTile(
            ...
            // Acción interactiva para comprobar el feedback visual al tocar la alerta
            onTap: () {
              ScaffoldMessenger.of(context).clearSnackBars();
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(
                  content: Text('Atendiendo alerta ${alerta.nivel}: ${alerta.servidor}'),
                  backgroundColor: esCritico ? cs.error : cs.tertiary,
                ),
              );
            },
